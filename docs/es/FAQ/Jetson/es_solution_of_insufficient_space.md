...
- Si estás usando una **placa portadora A20X**, el método para instalar el sistema usando la línea de comando está en [Flasheo a eMMC con línea de comando](/reComputer_J2021_J202_Flash_Jetpack#flashing-to-emmc-with-command-line).

- Si estás usando la **Placa Portadora reComputer J1010**, entonces usa la línea de comando para instalar el sistema en [Flasheo a eMMC con línea de comando](/reComputer_J1010_J101_Flash_Jetpack#flashing-jetpack-os-via-command-line).
