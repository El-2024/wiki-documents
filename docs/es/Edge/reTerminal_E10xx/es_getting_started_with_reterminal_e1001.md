...
- [Esquemático del reTerminal E1001 (PDF)](/getting_started_with_reterminal_e1001)
- [Hoja de Datos del ESP32S3](/getting_started_with_reterminal_e1001)
- [Documentación de la Plataforma SenseCraft HMI](https://wiki.seeedstudio.com/es/sensecraft_hmi_overview)
- [Repositorio de GitHub](/getting_started_with_reterminal_e1001)
