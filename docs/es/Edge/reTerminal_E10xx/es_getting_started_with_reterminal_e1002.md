...
Le recomendamos que **[complete la actualización del firmware de su producto](#preliminary)** tan pronto como lo reciba para obtener la mejor experiencia.
:::

:::danger Advertencia sobre la Vida Útil de la Pantalla
1. Si su reTerminal ha estado inactivo durante mucho tiempo, puede mantener presionado el botón verde del dispositivo durante 5 segundos para borrar el contenido de la pantalla (usando el firmware de fábrica), lo que puede prevenir eficazmente las sombras residuales y aumentar la vida útil de la pantalla.
2. Siempre que sea posible, no mantenga una pantalla estática durante un período prolongado (más de 1 día), ya que esto puede crear una imagen residual. Se recomienda que la imagen de la pantalla se actualice al menos una vez al día. Si el dispositivo no se utiliza durante mucho tiempo, se recomienda borrar el contenido de la pantalla del dispositivo.
3. Por favor, actualice la pantalla lo menos posible al usar y depurar el programa. Refrescar la pantalla a alta velocidad durante un período prolongado también puede reducir la vida útil de la pantalla.
:::

## Introducción

El reTerminal E1002 es una pantalla de papel electrónico a color de código abierto de 7,3 pulgadas con una excepcional duración de batería de 3 meses. Impulsado por ESP32-S3, admite de forma nativa nuestra plataforma SenseCraft HMI sin código para la creación sencilla de tableros, además de ser compatible con Home Assistant, TRMNL E-ink dashboard, Arduino y ESP-IDF para un mayor desarrollo. Con la pantalla de papel electrónico a todo color E Ink® Spectra™ 6, es perfecto para marcos digitales y visualización de tableros coloridos.

### Características

- **Hermosa Pantalla de Papel Electrónico a Color E Ink® Spectra™6 Lista para Usar**
