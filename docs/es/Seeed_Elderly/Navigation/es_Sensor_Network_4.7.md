...
slug: /es/Seeed_Elderly/Navigation/Sensor_Network_4.7
last_update:
  date: 01/20/2023
  author: Matthew
---
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            ...
            <a href="/Train-Deploy-AI-Model-A1101" target="_blank"><span><font color={'FFFFFF'} size={"3"}> Haz clic aquí para más información</font></span></a>
    </a>
</div>
...
<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <a href="/Raspberry-OpenWrt-Getting-Started" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Introducción con descripción general del hardware</font></span></a>
            <br/>
    ...
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <a href="/Linkstar_Datasheet" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Introducción con descripción general del hardware</font></span></a>
            <br/>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/Grove-Capacitive_Moisture_Sensor-Corrosion-Resistant" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Tipo Una Sonda</font></span></a>
            <br/>
            <a href="/Grove-Moisture_Sensor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Tipo Dos Sondas</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/Grove-Serial_RF_Pro" target="_blank"><span><font color={'FFFFFF'} size={"2"}> RF Serial Pro </font></span></a>
            <br/>
            <a href="/Grove-125KHz_RFID_Reader" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Lector RFID 125KHz </font></span></a>
            <br/>
            <a href="/Grove_LoRa_Radio" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Largo Alcance 868MHz </font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
...
<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <a href="/Radar_MR24HPC1" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Módulo de Presencia Estática Humana de Ondas Milimétricas 24GHz Lite - Parámetro Configurable</font></span></a>
            <br/>
            <a href="/Radar_MR24FDB1" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Sensor de Detección de Caídas de Ondas Milimétricas 24GHz </font></span></a>,
            <a href="/Radar_MR24HPB1" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Sensor de Presencia Estática Humana de Ondas Milimétricas 24GHz</font></span></a>
            <br/>
            <a href="/Radar_MR24BSD1" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Módulo de Monitoreo de Respiración Durante el Sueño de Ondas Milimétricas 60GHz</font></span></a>
            <br/>
            <a href="/Radar_MR60BHA1" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Módulo de Respiración y Latidos Cardíacos de Ondas Milimétricas 60GHz</font></span></a>
            <br/>
            <a href="/Radar_MR60FDA1" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Módulo de Detección de Caídas Pro de Ondas Milimétricas 60GHz</font></span></a>
            <br/>
            <a href="/Microwave-Sensor-24GHz-Doppler-Radar-Motion-Sensor-MW2401TR11" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Sensor de Microondas - Sensor de Movimiento de Radar Doppler 24GHz - MW2401TR11</font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/Photo_Reflective_Sensor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Sensor Fotorreflectivo </font></span></a>,
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/WiFi_Serial_Transceiver_Module" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Módulo Transceptor Serie WiFi</font></span></a>
            <br/>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/LinkIt" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Introducción</font></span></a>
            <br/>
...
<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/K1100_sensecap_node-red" target="_blank"><span><font color={'FFFFFF'} size={"3"}>  > SenseCAP & Node-Red para Servicios en la Nube</font></span></a>
            <br/>
...
<div class="independent_container">
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/Wio-Terminal-TinyML-EI-5" target="_blank"><span><font color={'FFFFFF'} size={"2"}>> Distinguir Bebidas</font></span></a>
            <br/>
    ...
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/Wio-Terminal-TinyML-TFLM-1" target="_blank"><span><font color={'FFFFFF'} size={"2"}> > Introducción a TensorFlow Lite Micro</font></span></a>
            <br/>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'left'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Seeed Studio XIAO nRF52840</font></div>
            <a href="/XIAO-BLE-Sense-TFLite-Getting-Started" target="_blank"><span><font color={'FFFFFF'} size={"2"}> > Comenzando con TensorFlow Lite</font></span></a>
            <br/>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/Grove-LCD_RGB_Backlight" target="_blank"><span><font color={'FFFFFF'} size={"2"}> LCD RGB Retroiluminado </font></span></a>
            <br/>
            <a href="/Grove-0.54_inch_Red_Dual_Alphanumeric_Display" target="_blank"><span><font color={'FFFFFF'} size={"2"}>Doble</font></span></a>,
            <a href="/Grove-0.54_inch_Red_Quad_Alphanumeric_Display" target="_blank"><span><font color={'FFFFFF'} size={"2"}>Cuádruple </font></span></a>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/Grove-Differential_Amplifier_v1.2" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Diferencial - Amplificado </font></span></a>
            <br/>
...
<div class="independent_container">
    ...
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <br/>
            <a href="/ODYSSEY-X86J4105-Firmata" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Tutorial de Firmata - Cómo Usar Firmata en Compatible con Arduino</font></span></a>
            <br/>
            <a href="/Software-FreeRTOS" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Tutorial de FreeRTOS - Cómo usar FreeRTOS para aplicar Multi-tareas</font></span></a>
            <br/>
...
<div class="independent_container">
    ...
    <a class="independent_item" style={{textAlign: 'left'}}>
            ...
            <a href="/Azure_IoT_CC" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Usar plataforma de compilación Codecraft para conectar IoT de Azure</font></span></a>
            <br/>
            ...
            <br/>
            <a href="/Barometric-Pressure-sensor-using-the-Wio-terminal" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Sensor de presión usando el Wio terminal</font></span></a>
            <br/>
