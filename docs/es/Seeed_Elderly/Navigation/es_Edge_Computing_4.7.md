...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/reTerminal" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Comenzando con reTerminal </font></span></a>
            <br/>
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/reComputer_Jetson_Series_Initiation" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Comenzando con la Serie reComputer </font></span></a>
            <br/>
...
<div class="independent_container">
    ...
    <a class="independent_item" style={{textAlign: 'center'}}>
            ...
            <a href="/Edgebox-rpi-200-codesys" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Codesys en controlador EdgeBox-RPI-200</font></span></a>
            <br/>
            <a href="/Contributor" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Más Publicaciones Pronto</font></span></a>
            <br/>
    </a>
</div>
...
<div class="independent_container">
    ...
    <a class="independent_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/Update-Jetson-Linux-OTA-Using-Allxon" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Actualizar Jetson Linux por aire usando Allxon </font></span></a>
            <br/>
            <a href="/reComputer_Jetson_Series_Resource" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Recursos Jetson </font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>reTerminal</font></div>
            <a href="/reTerminal-FAQ" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Instalación de SO Original</font></span></a>
            <br/>
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/reComputer_J1010_J101_Flash_Jetpack" target="_blank"><span><font color={'FFFFFF'} size={"2"}> J1010 | J101 Instalación de SO Original</font></span></a>
            <br/>
            <a href="/reComputer_J2021_J202_Flash_Jetpack" target="_blank"><span><font color={'FFFFFF'} size={"2"}> J2021 | J202 Instalación de SO Original</font></span></a>
            <br/>
            <a href="/reComputer_J1020_A206_Flash_JetPack" target="_blank"><span><font color={'FFFFFF'} size={"2"}> J1020 | A206 Instalación de SO Original</font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/reComputer_A203E_Flash_System" target="_blank"><span><font color={'FFFFFF'} size={"2"}> A203 Instalación de SO Original</font></span></a>
            <br/>
            <a href="/reComputer_A205E_Flash_System" target="_blank"><span><font color={'FFFFFF'} size={"2"}> A205E Instalación de SO Original</font></span></a>
            <br/>
            <a href="/Mini_AI_Computer_T906" target="_blank"><span><font color={'FFFFFF'} size={"2"}> T906 Instalación de SO Original</font></span></a>
            <br/>
    </a>
</div>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Alternativa NVIDIA Jetson</font></div>
            <a href="/Jetson_Xavier_AGX_H01_Driver_Installation" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Jetson Xavier AGX H01 Instalación de SO Original</font></span></a>
    </a>
</div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <a href="/reTerminalBridge" target="_blank"><span><font color={'FFFFFF'} size={"2"}> reTerminal E10-1 - Expande UPS, Gigabit Ethernet, LTE/4G/5G/LoRaWAN®, RS485/232, CAN, SATA 2.0</font></span></a>
            <br/>
...
<div class="intro_container">
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>Raspberry Pi</font></div>
            <a href="/Edge_Computing" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Instalación de SO Original</font></span></a>
    </a>
</div>
...
<div class="title_container">
    <a class="title_item" style={{textAlign: 'center'}}>
            ...
            <a href="/Grove_Base_Hat_for_Raspberry_Pi" target="_blank"><span><font color={'FFFFFF'} size={"2"}> HAT Base Grove </font></span></a>,
            <a href="/Grove_AI_HAT_for_Edge_Computing" target="_blank"><span><font color={'FFFFFF'} size={"2"}> HAT AI Grove</font></span></a>,
            <a href="/RS-485_Shield_for_Raspberry_Pi" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Pi HAT RS-485</font></span></a>,
            <a href="/8-Channel_12-Bit_ADC_for_Raspberry_Pi-STM32F030" target="_blank"><span><font color={'FFFFFF'} size={"2"}> HAT ADC de 8 Canales 12-Bit</font></span></a>,
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/Seeed-Studio-BeagleBone-Green-LCD-Cape-with-Resistive-Touch" target="_blank"><span><font color={'FFFFFF'} size={"2"}> BeagleBone® Green LCD Cape con Touch Resistivo</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/Raspberry_PI_Bplus_Case" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Carcasa Raspberry PI B Plus</font></span></a>
            <br/>
    </a>
    <a class="intro_item" style={{textAlign: 'center'}}>
            <div class="start_card_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"5"}>ODYSSEY X86J4105</font></div>
...
<div class="intro_container">
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/LoRa_LoRaWan_Gateway_Kit" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Kit Gateway LoRa®/LoRaWAN®</font></span></a>
            <br/>
    ...
    <a class="intro_item" style={{textAlign: 'center'}}>
            ...
            <br/>
            <a href="/Beagle_Bone_Green_and_Grove_IoT_Starter_Kit_Powered_by_AWS" target="_blank"><span><font color={'FFFFFF'} size={"2"}> Kit IoT de Inicio Grove AWS IoT para BeagleBone Green </font></span></a>
            <br/>
    </a>
</div>
