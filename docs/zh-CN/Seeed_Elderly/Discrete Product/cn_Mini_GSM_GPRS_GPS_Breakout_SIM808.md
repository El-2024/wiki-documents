...
<td> 发送指令 “AT” 以同步波特率。模块的串口默认设置为自动波特率模式，在此模式下，模块开启时不会输出任何指示。
</td></tr>
<tr>
<td> AT+IPR=9600
<span style="color: rgb(242,133,0)">OK</span></td>
<td> 将波特率设置为 9600bps，支持从 1200bps 到 115200bps 的波特率。
</td></tr>
<tr>
<td> AT+ECHARGE=1
<span style="color: rgb(242,133,0)">OK</span></td>
<td> 发送指令 “AT+ECHARGE=1” 以启用电池充电功能。默认情况下充电功能是关闭的。
</td></tr>
<tr>
<td> AT&amp;W
<span style="color: rgb(242,133,0)">OK</span></td>
...
Call Ready
SMS Ready</span></td>
<td>通过电源按钮重新开启模块，它将响应 GPS 和 GSM 的状态。
</td></tr>
<tr>
<td> AT+CBC
...
OK</span></td>
<td> 读取 GPS 定位状态，“Location Not Fix” 表示定位未成功。首次启动时至少需要 30 秒。_**GPS 必须在窗边或室外测试。**_
</td></tr>
<tr>
<td> AT+CGPSSTATUS?
<span style="color: rgb(242,133,0)"> +CGPSSTATUS: Location 3D Fix
OK</span></td>
<td> GPS 已成功定位并处于 3D 状态。
</td></tr>
<tr>
<td> AT+CGPSINF=0
...
<td> 获取当前 GPS 位置信息。参数格式：&lt;模式&gt;, &lt;海拔&gt;, &lt;经度&gt;, &lt;UTC 时间&gt;, &lt;TTFF&gt;, &lt;卫星数量&gt;, &lt;速度&gt;, &lt;航向&gt;
</td></tr>
<tr>
<td> AT+CGPSOUT=32
...
<td> 读取 NMEA $GPRMC 数据，其中 “2234.9414 N, 11357.1187 E” 是位置坐标。有关 NMEA 语句的更多详细信息，请[查看此网站](http://www.gpsinformation.org/dale/nmea.htm)。
</td></tr>
<tr>
<td> AT+CGPSRST=0
<span style="color: rgb(242,133,0)"> OK</span></td>
