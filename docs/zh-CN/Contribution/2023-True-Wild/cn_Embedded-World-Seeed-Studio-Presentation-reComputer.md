---
description: reComputer 系列
title: reComputer 系列
keywords:
- 嵌入式世界
image: https://files.seeedstudio.com/wiki/wiki-platform/S-tempor.png
slug: /cn/Embedded-World-Seeed-Studio-Presentation-reComputer
last_update:
  date: 03/13/2023
  author: Matthew
---
...
<div class="embedded_world_container">
    <a class="embedded_world_item" style={{textAlign: 'center'}} href="https://www.seeedstudio.com/make_sense_from_the_true_wild.html">
            <div class="embedded_world_title" style={{textAlign: 'center'}}><font color={'8DC215'} size={"6"}>reComputer 工业版: Xavier NX/ Orin Nano/ Orin NX</font></div>
            <div class="embedded_world_title" style={{textAlign: 'center'}}><font color={'FFFFFF'} size={"3"}>在设施或野外实现机器机器人化，21 TOPS 至 100 TOPS AI 性能</font></div>
    </a>
</div>