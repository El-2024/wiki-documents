...
{/* <table>
  <tr>
   <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/Traffic-Management-DeepStream-SDK/">DeepStream 示例</a></div>
    </td>
   <td style={{ textAlign: "center" }}>
    ...
    <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/Jetson-Nano-MaskCam/">MaskCam 项目</a></div>
    </td>
  </tr>
  <tr>
    <td style={{ textAlign: "center" }}>
      <img src="https://files.seeedstudio.com/wiki/reComputer-Jetson/sound_follow/robot.jpg" width="300" />
      <div><a href="https://wiki.seeedstudio.com/sound_follow_robot/">声音跟随机器人</a></div>
    </td>
    <td style={{ textAlign: "center" }}>
    ...
    <td style={{ textAlign: "center" }}>
      ...
      <div><a href="https://wiki.seeedstudio.com/deploy_deepseek_on_jetson_with_mlc/">DeepSeek 演示</a></div>
    </td>
  </tr>
</table>
