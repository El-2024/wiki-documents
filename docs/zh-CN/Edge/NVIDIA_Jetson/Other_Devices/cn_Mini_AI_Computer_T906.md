---
description: 在 T906 Mini PC 上刷入 Jetpack
title: T906 Mini PC
tags:
  - Mini PC Jetpack 刷入
...
Mini AI Computer T906 配备 Jetson AGX Orin 32GB 模组，提供高达 200TOPS 的 AI 性能，能够应对边缘端最复杂的 AI 工作负载。预装 Jetpack 5.0.2，支持 NVIDIA JetPack 和 DeepStream SDK、TensorRT、RIVA、Issac 软件库，以及 Seeed Edge AI 生态系统中的领先 AI 平台工具，您可以轻松开发和部署用于制造、配送、零售和智慧城市等领域的 AI 应用。

Mini AI Computer T906 配备 10GbE 和 1GbE 的以太网端口，可实现高速网络访问。您可以启用多达 10 路视频分析流。

内置的载板还为 GPS 模块、用于扩展 SSD 的 M.2 Key M、用于 WiFi 模块的 M.2 Key B、用于 5G 模块的 M.2 Key E 和 Mini PCIe 的 4G 模块预留了接口。

配备 3 个 RS232 接口，并通过出色的散热和外壳保护，T906 非常适合构建高能效的自主机器。

凭借高达 10 千兆以太网和超长 MTBF 稳定运行，这款超级计算机使高级分析成为可能，同时能够处理来自数十个 IP 摄像头的多路并发流。它支持 Wi-Fi 无线功能，并支持蓝牙、4G 和 5G 模块配置，以及 GPS 导航。

设备配备了 JEG 车规级连接器，提供 3 个 CAN FD 和 2 个 GPIO，可输入多个雷达传感器。它还配备了 GMSL 摄像头连接器，您可以利用它构建摄像头传感器集线器、控制单元或视频转码单元。这款边缘 AI 盒子可以实现自动驾驶、自主移动机器人（AMR）或无人地面设备的远程操作。

它配备了一套丰富的工业接口：1 个标准 RS232、1 个用于 UART 的 RS232 和 1 个用于时间同步触发的 RS232。
...
* 日本 JAE 车规级 IO 插头（1xPOWER，3xCAN，2xGPIO）
* 风扇和被动散热设计
    ...
    <tbody>
      ...
      <tr>
        <td colSpan={1} rowSpan={1} width={61} valign="middle" align>
          ...
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt"> </p>
        </td>
        <td colSpan={1} rowSpan={1} width={420} valign="middle" align>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt"> </p>
      ...
      <tr>
        ...
        <td colSpan={1} rowSpan={1} width={420} valign="middle" align>
          ...
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">(模块不包含)</p>
        </td>
      </tr>
      <tr>
        <td colSpan={1} rowSpan={1} width={61} valign="middle" align>
        ...
        <td colSpan={1} rowSpan={1} width={420} valign="middle" align>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt"> </p>
          <p className="paragraph text-align-type-center pap-line-1 pap-line-rule-auto pap-spacing-before-0pt pap-spacing-after-0pt">支持 GPS (模块不包含)</p>
        </td>
      </tr>
      <tr>
        <td colSpan={1} rowSpan={1} width={61} valign="middle" align>
      ...
      <tr>
        ...
        <td colSpan={1} rowSpan={1} width={420} valign align>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt"> </p>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">3xCAN (带 CAN 芯片)</p>
        </td>
      </tr>
      <tr>
        <td colSpan={1} rowSpan={1} width={420} valign align>
      ...
      <tr>
        ...
        <td colSpan={1} rowSpan={1} width={420} valign align>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt"> </p>
          <p className="paragraph text-align-type-left pap-line-1 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">GMSL 2 摄像头接口（兼容 GMSL1，需单独购买适配板）</p>
        </td>
      </tr>
      <tr>
        <td colSpan={1} rowSpan={1} width={61} valign align>
        ...
        <td colSpan={1} rowSpan={1} width={420} valign align>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt"> </p>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">带可充电电池的 RTC 接口</p>
        </td>
      </tr>
      <tr>
        <td colSpan={1} rowSpan={1} width={61} valign="middle" align>
      ...
      <tr>
        ...
        <td colSpan={1} rowSpan={1} width={420} valign align>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt"> </p>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt"> </p>
          <p className="paragraph text-align-type-left pap-line-1.3 pap-line-rule-auto pap-spacing-before-3pt pap-spacing-after-3pt">2x 状态指示灯</p>
        </td>
      </tr>
      <tr>
        <td colSpan={1} rowSpan={1} width={61} valign align>
...
!!! 注意
    Mini AI Computer T906 的 Jetson AGX Orin 模块的 EMMC 上预装了 **Jetpack 5.0.2**，这意味着您可以直接开始开发自己的应用程序。您可以跳过此部分，直接进入[下一节](#peripherals)。  
    如果您想为此设备刷写操作系统，请注意该系统的载板是定制设计的，因此需要下载并安装相关驱动程序。

### 所需硬件

在开始之前，您需要准备以下硬件：

- 安装了 Ubuntu 18.04 或 Ubuntu 20.04 操作系统的 Linux 主机电脑
...
- **步骤 2.** 使用 USB Type-C 数据线将 Mini AI Computer T906 连接到 Ubuntu 主机（数据线一端插入 Mini AI Computer T906 的 OTG 端口，另一端插入 Ubuntu 主机的 USB 3.0 插口）。

- **步骤 3.** 使用 Mini AI Computer T906 配置的电源为系统供电。

- **步骤 4.** 按下恢复按钮，然后**按住** Mini AI Computer T906 的**复位按钮**。

- **步骤 5.** 在 2 秒后释放复位按钮，最后释放恢复按钮，此时 T906 进入恢复模式（您可以通过在 Ubuntu 主机上运行命令 `lsusb` 检查是否存在 `Nvidia Corp` 设备）。

!!! 注意
    进入 USB 恢复模式时，系统不会启动，也不会从串口输出调试信息。
...
!!! 注意
    Mini AI Computer T906 不自带 4G 模块，以下操作基于 Neoway N720 4G 模块。

- **步骤 1.** 请下载 4G 模块驱动并解压文件包，然后通过 `终端` 将驱动复制到 `/etc/ppp/peers`：
...
- **步骤 2.** 进入 `/etc/ppp/peers` 目录，找到 `n720-ppp-dial.sh` 脚本。首次执行时需要授予执行权限，操作如下：
...
- **步骤 3.** 如果您希望实现 4G 自动连接功能，需要设置 `rc.local` 启动脚本以增加系统启动时的应用。
...
# 4G 自动拨号，如果已注册到网络，等待 30 秒以准备 4G 模块
TIME=`date +%Y%m%d%H%M`
...
- **步骤 3.** 您还可以通过以下命令检查 GPIO 引脚是否处于高电平或低电平：
...
!!! 注意
    以下步骤用于测试 GPS 模块，相关操作和软件适用于 HX-26-GN 系列 GPS 模块。请注意，标准产品中不包含 GPS 模块，需自行购买。
...
- **步骤 2.** 系统启动后，您可以在主目录位置找到 `twork` 文件夹，双击进入并右键选择 `在终端中打开`。
...
如果您看到以下输出，这意味着定位未成功，可能是信号太弱无法锁定位置，请前往开阔区域，将设备暴露在更多信号下以获取位置锁定。
...
!!!注意
    这是将 NVMe SSD 设置为系统磁盘以扩展 rootfs 存储大小的步骤，同时保留 EMMC 或 SD 卡作为系统启动分区。请注意，标准产品中不包含 NVMe SSD，您需要自行提供。
...
<div align="center"><img width={500} src="https://files.seeedstudio.com/wiki/recomputer-Jetson-20-1-H1/kuorong/1.png" /></div>
  ...
  在左侧选择您的 SSD，然后在右上角菜单栏下选择 **Format Disk**。
...
<div align="center"><img width={800} src="https://files.seeedstudio.com/wiki/recomputer-Jetson-20-1-H1/kuorong/ssd7.png" /></div>
  ...
  请为您的 SSD 命名，并在类型中选择 **Ext4**，然后点击“Create”。至此，我们已根据扩展要求完成 SSD 的准备工作。
...
```
  ...
  然后执行以下命令，将 eMMC 中的根目录文件构建到 SSD，此步骤的等待时间取决于您使用的根目录大小。
...
!!!注意
    脚本文件中的默认 SSD 路径是 `/dev/nvme0n1p1`，这也是 reComputer 默认分配的路径。如果您发现通过命令 `sudo fdisk -l` 检查到的 SSD 路径与此不符，请将 rootOnNVMe 中 **copy-rootfs-ssd.sh**、**data/setssdroot.service** 和 **data/setssdroot.sh** 文件中的所有 `/dev/nvme0n1p1` 路径更改为您的 SSD 所在路径。

<div align="center"><img width={800} src="https://files.seeedstudio.com/wiki/recomputer-Jetson-20-1-H1/kuorong/21.png" /></div>



上述扩展不会从 eMMC 中移除原始根目录内容。如果您不想从 SSD 启动，可以移除 SSD，系统仍会从 eMMC 启动。
