---
description: 在 reComputer 上使用 Infineon Wi-Fi 模块
title: 在 reComputer 上使用 Infineon Wi-Fi 模块
keywords:
- reComputer
- Wifi
...
<div align="center">(图片来源于 Embedded Artists：2EA M.2 模块由 Embedded Artists 和 Murata 共同开发，旨在评估、集成和易用性。)</div>
...
**步骤 1.** 下载并上传 Infineon [WiFi 驱动](https://szseeedstudio-my.sharepoint.cn/:u:/g/personal/youjiang_yu_szseeedstudio_partner_onmschina_cn/EQzCwQWQOwhNhhW-VHhKqogBYhan7liy9UY44QE4vhq95A?e=qq0ANC)到 reComputer。
...
:::caution
如果您之前通过 `sudo apt-get install iwlwifi-modules -y` 安装了 Intel 无线驱动，则需要在继续之前卸载此软件包。已知存在与 backport 兼容性的问题。
