...
title: Configuración TTN Mapper
keywords:
- Tracker
- TTN
...
[TTN Mapper](https://ttnmapper.org/) es una herramienta para mapear la cobertura de red de gateways conectados a The Things Stack.  
Consulta la documentación oficial en [TTN Mapper docs](https://docs.ttnmapper.org/) para más detalles.
...
[Conectar a The Things Network](https://wiki.seeedstudio.com/SenseCAP_T1000_tracker_TTN/).
...
<p align="center">
  <img src="https://files.seeedstudio.com/wiki/SenseCAP/Tracker/decoder.png" width="800" alt="Payload formatter TTN"/>
</p>

<details>

<summary>Decoder para TTN Mapper</summary>
...
1. Navega a `Integrations` → `Webhooks` en la consola de The Things Network, luego selecciona `TTN Mapper`.

<p align="center">
  <img src="https://files.seeedstudio.com/wiki/SenseCAP/Tracker/webhook-map.png" width="800" alt="Agregar Webhook TTN Mapper"/>
</p>

2. Asigna un nombre a tu integración completando el campo **Webhook ID**.

3. Ingresa una dirección de correo electrónico válida en el campo **Email address**.  
...
4. Para más detalles sobre experimentos y su uso, revisa la sección de Experiments en la documentación oficial de TTN Mapper.

5. Haz clic en el botón **Create TTN Mapper webhook** para finalizar.

<p align="center">
  <img src="https://files.seeedstudio.com/wiki/SenseCAP/Tracker/webhook2.png" width="800" alt="Crear Webhook TTN Mapper"/>
</p>

### Observar la cobertura de red

1. Ingresa a [TTN Mapper](https://ttnmapper.org/).
