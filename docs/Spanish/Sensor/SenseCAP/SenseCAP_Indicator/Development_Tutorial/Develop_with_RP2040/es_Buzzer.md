...
El buzzer incorporado en el SenseCAP Indicator es un buzzer pasivo, lo que significa que requiere una señal de CA (PWM) para activarse y emitir sonido. Esto te permite generar varios tonos y efectos.
...
Este ejemplo utiliza un buzzer para reproducir melodías. Envía una onda cuadrada de la frecuencia apropiada al buzzer para generar el tono correspondiente.
...
Este ejemplo muestra una alarma cuando el valor de CO₂ supera los 1000 ppm.
