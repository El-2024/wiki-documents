...
title:  Acceso a GitHub usando Wio Terminal
keywords:
...
# Lectura de Estadísticas de Repositorios Github con Wio Terminal

<div align="center"><img src="https://files.seeedstudio.com/wiki/Wio-Terminal/img/Github.gif" /></div>

Este tutorial introduce cómo usar Wio Terminal para conectarse a un servidor **HTTPS**, lo que significa que puedes usar Wio Terminal para obtener datos en vivo desde internet. En este ejemplo, Wio Terminal se conecta a una red Wi-Fi y obtiene datos desde Github.

Con esta base, puedes modificar el código para obtener información de otros APIs, como datos del clima, estadísticas de YouTube, etc.
...
* Obtiene estadísticas de repositorios Github

* Puede modificarse para consultar cualquier repositorio de Github

## Librerías Arduino necesarias

* Instalar la librería para pantalla LCD `Seeed_Arduino_LCD`. Más información en [Wio Terminal LCD](https://wiki.seeedstudio.com/Wio-Terminal-LCD-Overview/).

* Descargar el repositorio completo de [ArduinoJson](https://github.com/bblanchon/ArduinoJson) en tu computadora.

  * Instalar ArduinoJson en el IDE de Arduino desde: `Sketch` -> `Include Library` -> `Add .ZIP Library` y seleccionar el archivo ZIP descargado.
...
* Descargar el archivo [`Free_Fonts.h`](https://files.seeedstudio.com/wiki/Wio-Terminal/res/Free_Fonts.h) para usar las fuentes abreviadas incluidas en la librería LCD. Coloca este archivo en la misma carpeta del sketch.

* Descargar el código completo [aquí](https://files.seeedstudio.com/wiki/Wio-Terminal/res/GitHubStats.zip) o copiar el siguiente código.

* Cambiar el `ssid` y `password` por los de tu red Wi-Fi.
