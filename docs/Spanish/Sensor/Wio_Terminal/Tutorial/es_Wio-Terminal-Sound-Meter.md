...
Este ejemplo muestra cómo desplegar perfectamente el medidor de decibelios en el Wio Terminal.
...
:::note  
Por favor visita la [**Descripción general de audio**](https://wiki.seeedstudio.com/Wio-Terminal-Audio-Overview/) para la **Conexión de hardware**.  
:::

## Características

- Los dB pueden mostrarse en el dial, en lectura numérica y en gráfico de línea respectivamente.  
- Incluye una guía que introduce el significado de los valores en dB.

## Primeros pasos

Para comenzar con la librería de audio para Wio Terminal, por favor sigue lo siguiente:

## Instalación de librerías

1. Instala la librería de Audio `Seeed_Arduino_Audio`. Visita la [**Descripción general de audio**](https://wiki.seeedstudio.com/Wio-Terminal-Audio-Overview/) para más información.

2. Instala la librería para la pantalla LCD `Seeed_Arduino_LCD`. Visita [Wio Terminal LCD](https://wiki.seeedstudio.com/Wio-Terminal-LCD-Overview/) para más información.

3. Ahora, la librería puede ser instalada en el Arduino IDE. Abre el Arduino IDE, y haz clic en `Sketch` -> `Include Library` -> `Add .ZIP Library`, y selecciona el archivo `Seeed_Arduino_Audio` que acabas de descargar.

![InstallLibrary](https://files.seeedstudio.com/wiki/Wio-Terminal/img/Xnip2019-11-21_15-50-13.jpg)

## Mostrar el valor en dB en el Monitor de Arduino

Este ejemplo muestra el valor en dB en el Monitor de Arduino, para poder probar el código de dB.

:::note  
El código es bastante largo, así que puedes simplemente hacer clic en 'copiar al portapapeles' y luego pegarlo en el Arduino IDE.  
:::
