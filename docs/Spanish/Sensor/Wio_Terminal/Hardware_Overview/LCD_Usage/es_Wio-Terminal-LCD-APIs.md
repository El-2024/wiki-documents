---
title: Ejemplos de API TFT LCD
nointro:
keywords:
  - docs
  - docusaurus
image: https://wiki.seeedstudio.com/Wio-Terminal-LCD-APIs/
slug: /es/Wio-Terminal-LCD-APIs
last_update:
  date: 07/27/2025
  author: Guillermo
---
...
Este repositorio proporciona algunos gifs de los ejemplos de la librería TFT LCD, todos los ejemplos se encuentran bajo `File`->`Example`->`Seeed_Arduino_LCD` -> `320 x 240`. Puedes usar estos ejemplos para implementar en tu diseño.

Para más información sobre la pantalla TFT LCD, por favor visita [Conceptos Básicos de la Pantalla TFT LCD](https://wiki.seeedstudio.com/Wio-Terminal-LCD-Basic/).
