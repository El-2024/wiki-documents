...
<table>
  <tbody>
    ...
    <tr>
      <td width={400}>Rango de voltaje de trabajo</td>
...
<table>
  <tbody>
    ...
    <tr style={{ fontSize: '90%' }}>
      <td width={200}>2</td>
      <td width={150}>Esfera de acero inoxidable</td>
      <td width={150}>1</td>
    ...
    <tr style={{ fontSize: '90%' }}>
      <td>7</td>
      <td>Anillo O-ring de sellado</td>
      <td>1</td>
      <td>Goma</td>
      <td></td>
    </tr>
...
<table>
  <tbody>
    <tr>
      ...
      <td width={400}>Voltaje &gt; 4.5 V (con entrada de 5 VDC)</td>
    </tr>
    <tr>
      <td>Nivel bajo de pulso de salida</td>
      <td>Voltaje &lt; 0.5 V (con entrada de 5 VDC)</td>
    </tr>
    <tr>
      <td>Precisión</td>
      <td>±3% (para caudales entre 1 y 10 L/min)</td>
    </tr>
    <tr>
