...
デフォルトでは、MR60BHA2は[XIAO ESP32C6](/ja/xiao_esp32c6_getting_started)と組み立て済みで提供されますが、通信と統合のために様々な他のマイクロコントローラーと互換性があります。
