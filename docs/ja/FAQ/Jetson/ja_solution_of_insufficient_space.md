...
- **reComputer J1010 Carrier Board**を使用している場合は、[コマンドラインを使用したeMMCへのフラッシュ](/reComputer_J1010_J101_Flash_Jetpack#flashing-jetpack-os-via-command-line)でコマンドラインを使用してシステムをインストールします。
